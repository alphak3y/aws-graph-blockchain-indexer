...
class TheGraphCluster extends Construct {
  ...
  constructor(scope, id, props) {
    ...
    const createDBLambda = new NodejsFunction(this, 'createDBLambda', {
      ...
      bundling: {
        externalModules: [
          // 'aws-sdk', // NOTE: the 'aws-sdk' is not available in the Lambda runtime after Node 16
          'pg-native',
        ],
        nodeModules: ['aws-sdk'],
    ...
    const graphnodeContainer = taskDefinition.addContainer('graph-node', {
      ...
      image: ContainerImage.fromRegistry('graphprotocol/graph-node:v0.36.0'),
      memoryLimitMiB: 8192,
